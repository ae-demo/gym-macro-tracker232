...
export const SCOPES: readonly Scope[] = ["coach-links:accept", "coach-links:invite", "coach-links:list", "coach-links:revoke", "feedback:create", "feedback:read", "logs:edit", "logs:log", "logs:read", "logs:review", "targets:read", "targets:review", "targets:set"];

/** Every role a person can hold, sorted. Service-kind roles are not here. */
export const ROLES: readonly Role[] = ["Coach", "Trainee"];
...
export const ROLE_GRANTS: Record<Role, readonly Scope[]> = {
  "Coach": ["coach-links:accept", "coach-links:list", "feedback:create", "logs:review", "targets:review"],
  "Trainee": ["coach-links:invite", "coach-links:list", "coach-links:revoke", "feedback:read", "logs:edit", "logs:log", "logs:read", "targets:read", "targets:set"],
};
