...
export const mockRoles: readonly { readonly name: string; readonly grants: readonly string[] }[] = [
  { name: "Trainee", grants: ["coach-links:invite", "coach-links:list", "coach-links:revoke", "feedback:read", "logs:edit", "logs:log", "logs:read", "targets:read", "targets:set"] },
  { name: "Coach", grants: ["coach-links:accept", "coach-links:list", "feedback:create", "logs:review", "targets:review"] },
];
